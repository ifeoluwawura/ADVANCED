...
.then(data => {
    ...
    let myproductContent = products.map(product => {
       return `
        <div class="bg-white border border-gray-200 shadow-sm p-5 text-center flex justify-between rounded-lg h-full">
            <div class="w-full h-32 flex items-center justify-center bg-gray-50 rounded mb-3">
